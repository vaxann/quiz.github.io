...
(function($) {
  ...
  ColorSelector.prototype = {
    ...
    _init : function() {
      ...
      var $markupUl = $("<ul>").addClass("dropdown-menu").addClass("noclose");
      ...
      var $markupA = $("<button>").attr("data-toggle", "dropdown").addClass("btn btn-default dropdown-toggle btn-block").attr("data-placeholder", "Выберите цвет").append($markupSpan);
